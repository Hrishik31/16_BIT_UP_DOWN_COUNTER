...
#
# Created by icc2 write_sdc on Tue Jun  3 14:23:01 2025
#
################################################################################
...
create_clock -name Clock -period 4 -waveform {0 2} [get_ports {Clock}]
set_propagated_clock [get_clocks {Clock}]
# Warning: Libcell power domain derates are skipped!

# Set latency for io paths.
# -origin useful_skew
set_clock_latency -min 0.0355148 [get_clocks {Clock}]
# -origin useful_skew
set_clock_latency -max 0.0369358 [get_clocks {Clock}]
