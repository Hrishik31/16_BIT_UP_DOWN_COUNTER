...
create_lib -ref_lib $PDK_PATH/lib/ndm/saed32rvt_c.ndm UP_DOWN_COUNTER23_LIB

read_verilog {./../DC/results/up_down_counter_16bit.mapped.v} -library UP_DOWN_COUNTER23_LIB -design up_down_counter -top up_down_counter
...
#scenario10:
initialize_floorplan -core_utilization 0.75 -coincident_boundary true -core_offset {2 3} -shape R -orientation W
place_pins -self
create_placement -floorplan
